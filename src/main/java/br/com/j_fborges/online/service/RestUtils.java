...
public class RestUtils {
	...
	private void logCall(HttpMethod method, String url, HttpEntity<?> httpEntity, Object[] uriVariables) {
		...
		logger.debug("RUNNING ENDPOINT WITH {} IN URL: {}, PARAMETERS: {}, HEADERS: {} AND BODY: {}", method, url, uriVariables, asJSON(headers), asJSON(body));
	}
	
	private void logError(HttpMethod method, String url, Exception e) {
		logger.error("ERROR ON ENDPOINT WITH {} IN URL: {} - {}", method, url, e.getMessage());
	}
